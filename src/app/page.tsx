...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 text-zinc-950 antialiased dark:bg-[#05070d] dark:text-white">
      {/* Background */}
      ...
      <header className="mx-auto flex w-full max-w-6xl items-center justify-between px-6 py-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-semibold leading-4">Moon AI Automation</p>
      ...
      {/* Hero */}
      <main>
        <section className="mx-auto max-w-6xl px-6 pb-10 pt-10 sm:pb-16 sm:pt-14">
          <div className="grid gap-10 lg:grid-cols-12 lg:items-center">
            <div className="lg:col-span-7">
              <div className="flex flex-wrap items-center gap-2">
                <Badge>24/7 lead capture</Badge>
                <Badge>Instant answers</Badge>
              ...
              <p className="mt-5 max-w-2xl text-pretty text-base leading-7 text-zinc-600 dark:text-zinc-300">
                I build custom AI agents and automations that reply instantly,
                capture contact info, route requests, and book appointments—so
                your business keeps moving even when you’re busy.
              </p>

              <div className="mt-7 flex flex-col gap-3 sm:flex-row">
                <Button href={calendlyUrl}>Book a free discovery call</Button>
            ...
            <div className="lg:col-span-5">
              <div className="rounded-3xl border border-zinc-200 bg-white/70 p-6 shadow-sm backdrop-blur dark:border-white/10 dark:bg-white/5">
                <p className="text-sm font-semibold text-zinc-950 dark:text-white">
                  Example: what your AI agent can do
                </p>
                <div className="mt-4 space-y-3 text-sm text-zinc-700 dark:text-zinc-200">
                  ...
                  <div className="rounded-2xl bg-zinc-950 p-4 text-white dark:bg-white dark:text-zinc-950">
                    ...
                    <p>
                      “Yes—here’s our service area and typical pricing. What’s a
                      good email and address so we can give you an accurate
                      quote?”
                    </p>
                  </div>
                  <div className="rounded-2xl bg-zinc-100 p-4 dark:bg-white/10">
                    ...
                    <p>
                      Lead captured → auto follow-up → calendar booking → CRM
                      updated.
                    </p>
                  </div>
                </div>
        ...
        <section className="mx-auto max-w-6xl px-6 py-12 sm:py-16">
          <SectionHeading
            eyebrow="The problem"
            title="Small business owners are drowning in interruptions."
            desc="If inquiries aren’t answered fast, you lose the sale. If your team is constantly context-switching, you lose time."
          />
          <div className="mt-10 grid gap-4 md:grid-cols-3">
            <Feature
              title="Leads go cold"
              desc="Most businesses miss leads simply because they can’t respond instantly—especially after hours."
              icon={<span>⚡</span>}
            />
            <Feature
              title="Same questions every day"
              desc="Pricing, availability, service area, intake steps… it’s repetitive and costly."
              icon={<span>🔁</span>}
            />
            <Feature
              title="Hiring is expensive"
              desc="You don’t need another full-time person. You need better systems."
              icon={<span>💸</span>}
            />
          </div>
        </section>
        ...
        <section className="mx-auto max-w-6xl px-6 py-12 sm:py-16">
          <SectionHeading
            ...
            title="Custom AI agents built around your actual workflow."
            desc="Not a generic chatbot. A practical agent that answers, qualifies, routes, and triggers automations—built specifically for your business."
          />
          <div className="mt-10 grid gap-4 md:grid-cols-3">
            <Feature
              title="24/7 lead capture"
              desc="Instant replies + contact capture so your pipeline keeps filling." 
              icon={<span>🌙</span>}
            />
            <Feature
              title="Hours saved weekly"
              desc="Automate repetitive Q&A and admin tasks so you can focus on delivery." 
              icon={<span>⏱️</span>}
            />
            <Feature
              title="Better customer experience"
              desc="Fast, consistent answers and smooth handoff to your team when needed." 
              icon={<span>🤝</span>}
            />
          </div>
        </section>
        ...
        >
          <SectionHeading
            ...
            desc="We keep it lean: diagnose the bottleneck, build the agent, ship, then optimize." 
          />
          <div className="mt-10 grid gap-4 md:grid-cols-3">
            <Step
              n="1"
              title="Discovery call"
              desc="We map your lead flow and identify the highest-leverage automation." 
            />
            <Step
              n="2"
              title="Custom build"
        ...
        <section className="mx-auto max-w-6xl px-6 py-12 sm:py-16">
          <SectionHeading
            eyebrow="Proof"
            title="Real results (placeholders you can replace)."
            desc="Swap these with your first client wins and this page becomes a conversion machine." 
          />
          ...
          <div className="mt-10 grid gap-4 md:grid-cols-2">
            <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-white/5">
              ...
              <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-300">
                Reduced average response time from <b>4 hours</b> → <b>30 seconds</b>.
                Captured leads after-hours and routed them to the right person.
              </p>
              <p className="mt-4 text-xs text-zinc-500 dark:text-zinc-400">
                “We started getting booked while we were closed.”
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-white/5">
              ...
              <p className="mt-4 text-xs text-zinc-500 dark:text-zinc-400">
                “It’s like we hired an assistant without hiring an assistant.”
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="grid gap-10 lg:grid-cols-12 lg:items-center">
            <div className="lg:col-span-7">
              <SectionHeading
                ...
                desc="I’m Sam — I build practical automations and AI systems that reduce busywork and drive revenue. If you want flashy buzzwords, I’m not your guy. If you want outcomes, let’s talk." 
              />
            </div>
            <div className="lg:col-span-5">
        ...
        {/* FAQ */}
        <section id="faq" className="mx-auto max-w-6xl px-6 py-12 sm:py-16">
          <SectionHeading
            eyebrow="FAQ"
            title="Questions you’re probably thinking."
            desc="If you have a different question, just book a call and ask it straight." 
          />

          <div className="mx-auto mt-10 max-w-3xl divide-y divide-zinc-200 rounded-2xl border border-zinc-200 bg-white shadow-sm dark:divide-white/10 dark:border-white/10 dark:bg-white/5">
            {faqs.map((f) => (
        ...
        <section className="mx-auto max-w-6xl px-6 pb-20 pt-6">
          <div className="rounded-3xl border border-zinc-200 bg-white/70 p-8 shadow-sm backdrop-blur dark:border-white/10 dark:bg-white/5 sm:p-10">
            <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-center">
              <div>
                ...
                <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-300">
                  We’ll identify your highest-leverage automation and map next
                  steps.
                </p>
              </div>
      ...
      <footer className="mx-auto w-full max-w-6xl px-6 pb-10">
        <div className="flex flex-col justify-between gap-4 border-t border-zinc-200 pt-8 text-sm text-zinc-600 dark:border-white/10 dark:text-zinc-300 sm:flex-row">
          <p>© {new Date().getFullYear()} Moon AI Automation</p>
